...
public class MessageConstant {
    ...
    public static final String PASSWORD_ERROR = "Password is incorrect";
    ...
    public static final String CATEGORY_BE_RELATED_BY_SETMEAL = "Current category is associated with setmeal, cannot delete";
    public static final String CATEGORY_BE_RELATED_BY_DISH = "Current category is associated with dish, cannot delete";
    ...
    public static final String SETMEAL_ENABLE_FAILED = "Setmeal contains dishes that are not on sale, cannot enable";
    ...
    public static final String SETMEAL_ON_SALE = "Setmeal currently on sale cannot be deleted";
    public static final String DISH_BE_RELATED_BY_SETMEAL = "Current dish is associated with setmeal, cannot delete";
